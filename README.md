...
| Taskade MCP Server for n8n | Connects n8n to Taskade via the MCP community node or SSE endpoint, providing 62+ tools for project management, tasks, docs, and AI agents. | Productivity/Integration | [Link to Repo](https://github.com/taskade/mcp) |
